...
const Footer = () => {
  return (
    <footer className='bg-locoxo-header text-white mt-20'>
      <div className='max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-16 py-16'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12'>
          ...
          <div className='space-y-4'>
            ...
            <div className='flex gap-4 pt-4'>
              <a href='#' className='w-10 h-10 border border-gray-700 hover:border-locoxo-orange flex items-center justify-center transition-all hover:scale-[1.4]'>
          ...
          {/* Contact Info */}
          <div>
            <h3 className='text-sm font-bold tracking-wide mb-6'>GET IN TOUCH</h3>
            <ul className='space-y-3 text-sm text-gray-400'>
              <li className='flex items-start gap-2'>
                <svg className='w-5 h-5 mt-0.5 flex-shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z' />
                </svg>
                <span>+91 8824589682</span>
              </li>
              <li className='flex items-start gap-2'>
                <svg className='w-5 h-5 mt-0.5 flex-shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' />
                </svg>
                <span>locoxo.support@gmail.com</span>
              </li>
              <li className='flex items-start gap-2'>
                <svg className='w-5 h-5 mt-0.5 flex-shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                ...
                <span>Badi Haibowal, Ludhiana, Punjab – 141001, India</span>
              </li>
            </ul>
          </div>
        </div>
